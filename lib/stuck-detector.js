...
- "ask": one situation-specific question to the blocked POC for the precise missing next step / ETA. Tailor to THIS thread, not a template. Do NOT include raw Slack user IDs (like U0B99EPHE5P) or <@...> mentions in any field — refer to people by name only; the system adds the correct @mentions separately.
- "last_activity": <=100 char paraphrase of the most recent substantive message + who sent it (digest only).

Return ONLY compact JSON:
{"status":"open|closed","blocker":"<key or null>","sku":"<sku or null>","pickup_dest":"proms|warehouse|null","waiting_on":"<name or role or null>","issue_reported":"<...>","steps_taken":"<...>","current_status":"<...>","one_line":"<...>","ask":"<...>","last_activity":"<...>"}`;
