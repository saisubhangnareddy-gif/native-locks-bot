...
- "handoff": true if someone (a POC or agent) has asked ANOTHER person to do/provide something and we are now waiting on that other person — e.g. "@Yuvraj please share invoice", "@Manuranjan please replace the lock", "@Padmanabhan please add reverse pickup". The person who was ASKED owes the next step. Otherwise false.
- "next_actor": the DISPLAY NAME of person B (the one who must act next), copied EXACTLY as it appears in the transcript (e.g. "Yuvraj Gupta", "Vikash", "Janmayjay Sharma", "Padmanabhan"). If the next step is owed by the escalation agent / requester who must upload something (invoice/sheet/image), that agent IS a named person in the thread — return their name. Only use a generic role word ("PX", "logistics") if truly no named person owns it. If nobody specific, null.
- "next_action_needed": <=120 char — the concrete thing person B must do (e.g. "upload replacement invoice", "confirm if the visit fixed the issue", "add to reverse-pickup sheet"). Null if unclear.
- "asked_by": the DISPLAY NAME of person A (who asked person B to act), exactly as in the transcript, or null. This person gets cc'd.
...
{"status":"open|closed","blocker":"<key or null>","sku":"<sku or null>","pickup_dest":"proms|warehouse|null","active_sme":"<sme first name or null>","handoff":true|false,"next_actor":"<display name of person who must act, or PX/logistics, or null>","asked_by":"<display name of person who asked, or null>","next_action_needed":"<...>","waiting_on":"<name or role or null>","issue_reported":"<...>","steps_taken":"<...>","current_status":"<...>","one_line":"<...>","ask":"<...>","last_activity":"<...>"}`;
