...
- "handoff": true if the latest substantive request addresses ANOTHER person (or people) to do/provide something and we are now waiting on them. Otherwise false.
...
{"status":"open|closed","blocker":"<key or null>","sku":"<sku or null>","pickup_dest":"proms|warehouse|null","active_sme":"<sme first name or null>","handoff":true|false,"next_actor":["<display name(s) who must act>"],"asked_by":"<display name of person who asked, or null>","next_action_needed":"<...>","waiting_on":"<name or role or null>","issue_reported":"<...>","steps_taken":"<...>","current_status":"<...>","one_line":"<...>","ask":"<...>","last_activity":"<...>"}`;
