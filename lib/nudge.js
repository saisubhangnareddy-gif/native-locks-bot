...
function composeNudge({ analysis, isRenudge }) {
  ...
  // SUMMARY block (full thread arc) first, then ACTIONABLE block.
  // No "Latest update" here — that lives in the digest; the latest message is
  // already visible right there in the thread.
  const lines = [];
