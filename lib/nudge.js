...
// after a mention ("@Rushali create revisit", "@Sneha plz send rf"). Kept tight
// to avoid false positives (the old blunt extractor's failure mode).
const TAIL_REQUEST = /\b(please|pls|plz|pls\.|kindly|need you to|needs to|we need to|can you|could you|requesting you|request you|kindly help)\b/i;
