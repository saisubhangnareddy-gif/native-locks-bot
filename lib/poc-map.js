...
const BLOCKERS = {
  ...
  revisit_audit_quality: {
    ...
    // SMEs audit the PX work; keep the SKU RCA owner looped since they own the
    // technical diagnosis behind the revisit.
    pocs: (ctx) => [...new Set([...SMES, ...rcaPocsForSku(ctx.sku)])],
...
module.exports = { PEOPLE, SMES, BLOCKERS, CRITICAL_SIGNALS, CRITICAL_CC, DEFAULT_CC, rcaPocsForSku };
