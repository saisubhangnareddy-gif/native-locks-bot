...
const PEOPLE = {
  ...
  BHASKAR:      "U06MHTAHUEA", // Bhaskar — L2/L3 RCA + unknown-issue POC (escalation only)
...
const BLOCKERS = {
  ...
  rca_not_closed: {
    ...
    // Firmware/camera/tech RCA -> Abhiram (Engineering) + Harshavardhan (SME).
    // Bhaskar is L2/L3 / unknown-issue POC — not the default RCA tag.
    pocs: [PEOPLE.ABHIRAM, PEOPLE.HARSHA],
