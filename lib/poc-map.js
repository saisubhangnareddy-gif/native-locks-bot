...
const CRITICAL_SIGNALS = {
  lockout: {
    ...
    // Tight lockout phrases only. Deliberately NOT "not opening"/"unable to
    // open" — almost every lock issue says that; it does not mean the customer
    // is physically stuck outside. A lockout needs an explicit locked-out phrase.
    keywords: ["lockout", "locked out", "cannot get inside", "can't get in", "cannot enter", "can't enter", "stuck outside", "standing outside", "cx is lockout"],
  },
  social_media_legal: {
