...
const { PEOPLE } = require("./poc-map");

// Is this message a post from the nudger bot itself (its own nudge)? Its posts
// must NOT count as "someone replied", or the consecutive-nudge / 3-strike logic
// never advances. Detect three ways (any one): bot_id (present on app/bot-token
// posts), the bot's user id, OR the unmistakable shape of OUR nudge text.
